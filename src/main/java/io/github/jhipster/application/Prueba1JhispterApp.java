...
public class Prueba1JhispterApp {

    private static final Logger log = LoggerFactory.getLogger(Prueba1JhispterApp.class);

    private final Environment env;

    public Prueba1JhispterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes Prueba1Jhispter.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Prueba1JhispterApp.class);
